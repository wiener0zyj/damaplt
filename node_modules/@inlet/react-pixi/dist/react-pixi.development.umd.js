(function (global, factory) {
  ...
  (factory((global.ReactPixi = {}),global.PIXI,global.React));
}(this, (function (exports,PIXI,React) { 'use strict';
  ...
  var getTextureFromProps = function getTextureFromProps(elementType, _ref) {
    ...
    invariant_1(texture instanceof PIXI.Texture, elementType + ' texture needs to be typeof `PIXI.Texture`');
    return texture;
  };
  /**
  ...
  function applyDefaultProps(instance, oldProps, newProps) {
    invariant_1(PIXI.DisplayObject.prototype.isPrototypeOf(instance), 'instance needs to be typeof `PIXI.DisplayObject`, ' + 'got `%s`', _typeof(instance)); // update event handlers
  ...
  var NineSlicePlane = function NineSlicePlane(root, props) {
    ...
    var nineSlicePlane = new PIXI.mesh.NineSlicePlane(texture, leftWidth, topHeight, rightWidth, bottomHeight);
  ...
  var ParticleContainer = function ParticleContainer(root, props) {
    ...
    var container = new PIXI.particles.ParticleContainer(maxSize, properties, batchSize, autoResize);
  ...
  var Sprite = function Sprite(root, props) {
    var sprite = new PIXI.Sprite(getTextureFromProps('Sprite', props));
  ...
  var TilingSprite = function TilingSprite(root, props) {
    ...
    var ts = new PIXI.extras.TilingSprite(texture, width, height);
  ...
  var Mesh = function Mesh(root, props) {
    ...
    var vertices = props.vertices,
        ...
        drawMode = _props$drawMode === void 0 ? PIXI.mesh.Mesh.DRAW_MODES.TRIANGLES : _props$drawMode;
    var mesh = new PIXI.mesh.Mesh(texture, vertices, uvs, indices, drawMode);

    mesh.applyProps = function (instance, oldProps, newProps) {
      var image = newProps.image,
          texture = newProps.texture,
          props = _objectWithoutProperties(newProps, ["image", "texture"]);
  ...
  */
  ...
  var aa=objectAssign,ba=invariant_1,ca=React,m=emptyObject_1,da=shallowEqual_1;function n(a){for(var b=arguments.length-1,c="https://reactjs.org/docs/error-decoder.html?invariant="+a,d=0;d<b;d++)c+="&args[]="+encodeURIComponent(arguments[d+1]);ba(!1,"Minified React error #"+a+"; visit %s for the full message or use the non-minified dev environment for full errors and additional helpful warnings. ",c);}
  ...
  function nb(a){var b="";do{a:switch(a.tag){case 0:case 1:case 2:case 5:var c=a._debugOwner,d=a._debugSource;var e=sa(a);var f=null;c&&(f=sa(c));c=d;e="\n    in "+(e||"Unknown")+(c?" (at "+c.fileName.replace(/^.*[\\\/]/,"")+":"+c.lineNumber+")":f?" (created by "+f+")":"");break a;default:e="";}b+=e;a=a.return;}while(a);return b}var ob=[],pb=-1;function y(a){return {current:a}}function z(a){0>pb||(a.current=ob[pb],ob[pb]=null,pb--);}function A(a,b){pb++;ob[pb]=a.current;a.current=b;}
  ...
  var ReactInternals = React$$1.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
  ...
  var files = ["dist/", "LICENSE", "index.d.ts", "index.js", "module.js"];
  ...
  function render(element, container) {
    ...
    invariant_1(PIXI.Container.prototype.isPrototypeOf(container), 'Invalid argument `container`, expected instance of `PIXI.Container`.');
  ...
  var withPixiApp = function withPixiApp(BaseComponent) {
    var wrapper = function wrapper(props) {
      return React.createElement(context.Consumer, null, function (app) {
...
//# sourceMappingURL=react-pixi.development.umd.js.map
